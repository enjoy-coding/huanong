...
-- 20、APP版本管理
-- ----------------------------
drop table if exists prd_appversion;
CREATE TABLE `prd_appversion` (
  `version_id`       bigint(20)    NOT NULL,
  `create_time`      datetime      DEFAULT NULL,
  `create_by`        varchar(64)   DEFAULT NULL,
  `version_number`   float         DEFAULT NULL   COMMENT '版本号',
  `version_os`       varchar(16)   DEFAULT NULL   COMMENT '系统类型',
  `version_package`  varchar(128)  DEFAULT NULL   COMMENT '包名',
  `version_special`  varchar(64)   DEFAULT NULL   COMMENT '特性',
  `version_name`     varchar(128)  DEFAULT NULL   COMMENT '名称',
  `app_file`         bigint(20)    DEFAULT NULL,
  `icon_file`        bigint(20)    DEFAULT NULL,
