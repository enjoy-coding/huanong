  ...
  */
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.createVideoNode = function (url) {
          // video url patterns(youtube, instagram, vimeo, dailymotion, youku, mp4, ogg, webm, flv)
          ...
          var flvRegExp = /^.+.(flv)$/;
          var flvMatch = url.match(flvRegExp);
          ...
          else if (mp4Match || oggMatch || webmMatch || flvMatch) {
