package com.feather.framework.shiro.web.session;
...
public class OnlineWebSessionManager extends DefaultWebSessionManager {
    ...
    public void setCustomLogin(CustomLogin customLogin) {
    ...
    protected Serializable getSessionId(ServletRequest request, ServletResponse response) {
        if (customLogin != null && customLogin.existsSessionId(request)) {
            String id = customLogin.getSessionId(request, response);
