 ...
 * @date 2018/3/4 10:52
 */
public class CmsArticleColumnProcessor extends CmsAbstractProcess {

    // 标签名
    private static final String TAG_NAME = "article-column";


    public CmsArticleColumnProcessor(String dialectPrefix) {
