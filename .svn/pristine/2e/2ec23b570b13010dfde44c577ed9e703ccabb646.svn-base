 ...
 * @date 2020-05-14
 */
public interface ZhsqZhzlMapper
{
     ...
     * @return
     */
    public Map<String, Object> getZdNl(Map<String, Object> maps);
     ...
     * @return
     */
    public  Map<String,Object> selectZdsjFslCount(Map<String, Object> maps);
