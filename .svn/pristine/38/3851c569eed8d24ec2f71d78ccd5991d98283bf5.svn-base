...
public abstract interface HCNetSDK extends StdCallLibrary {
    public static final HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(HCNetSDKPath.getDllPath(), HCNetSDK.class);
    /*** 宏定义 ***/
    // 常量
    ...
    public static class NET_DVR_COMPRESSION_INFO_V30 extends Structure {
        ...
        public byte byResolution; // 分辨率0-DCIF 1-CIF, 2-QCIF, 3-4CIF, 4-2CIF
                                  ...
                                  // 18-SVGA （800*600）19-HD720p（1280*720）20-XVGA
                                  // 21-HD900p
        ...
        public int dwVideoBitrate; // 视频码率 0-保留 1-16K 2-32K 3-48k 4-64K 5-80K
                                   // 6-96K 7-128K 8-160k 9-192K 10-224K 11-256K
                                   // 12-320K 13-384K 14-448K 15-512K 16-640K
                                   // 17-768K 18-896K 19-1024K 20-1280K 21-1536K
                                   // 22-1792K 23-2048最高位(31位)置成1表示是自定义码流,
                                   // 0-30位表示码流值。
        public int dwVideoFrameRate; // 帧率 0-全部; 1-1/16; 2-1/8; 3-1/4; 4-1/2;
                                     // 5-1; 6-2; 7-4; 8-6; 9-8; 10-10; 11-12;
                                     // 12-16; 13-20; V2.0版本中新加14-15; 15-18;
                                     // 16-22;
    ...
    public static class NET_DVR_COMPRESSION_INFO extends Structure {// 码流压缩参数(子结构)
        ...
        public int dwVideoBitrate; // 视频码率 0-保留 1-16K(保留) 2-32K 3-48k 4-64K
                                   ...
                                   // 11-256K 12-320K
                                   // 13-384K 14-448K 15-512K 16-640K 17-768K
                                   // 18-896K 19-1024K 20-1280K 21-1536K
                                   // 22-1792K 23-2048K
                                   // 最高位(31位)置成1表示是自定义码流, 0-30位表示码流值(MIN-32K
                                   // MAX-8192K)。
        public int dwVideoFrameRate; // 帧率 0-全部; 1-1/16; 2-1/8; 3-1/4; 4-1/2;
                                     // 5-1; 6-2; 7-4; 8-6; 9-8; 10-10; 11-12;
                                     // 12-16; 13-20;
    ...
    public static class NET_DVR_VOOUT extends Structure {
        ...
        public short wScreenSaveTime; /*
                                       * 屏幕保护时间
                                       * 0-从不,1-1分钟,2-2分钟,3-5分钟,4-10分钟,5-20分钟,6-
                                       * 30分钟
                                       */
    ...
    // 状态码
    public static final int NET_SDK_GET_NEXT_STATUS_SUCCESS = 1000;// 成功读取到数据，处理完本次数据后需要再次调用NET_DVR_GetNextRemoteConfig获取下一条数据
    public static final int NET_SDK_GET_NEXT_STATUS_NEED_WAIT = 1001;// 需等待设备发送数据，继续调用NET_DVR_GetNextRemoteConfig
    public static final int NET_SDK_GET_NEXT_STATUS_FINISH = 1002; // 数据全部读取完，可调用NET_DVR_StopRemoteConfig结束长连接
    public static final int NET_SDK_GET_NEXT_STATUS_FAILED = 1003; // 读取失败，可调用NET_DVR_StopRemoteConfig结束长连接
    public static final int NET_SDK_GET_NEXT_STATUS_EXCEPTION = 1004;// 读取异常，可调用NET_DVR_StopRemoteConfig结束长连接
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("sSerialNumber", "byAlarmInPortNum", "byAlarmOutPortNum", "byDiskNum", "byDVRType",
                    ...
                    "byLanguageType", "byVoiceInChanNum", "byStartVoiceInChanNo", "bySupport5", "bySupport6",
                    "byMirrorChanNum", "wStartMirrorChanNo", "bySupport7", "byRes2");
        }
    }
    ...
    public static class NET_DVR_USER_LOGIN_INFO extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("sDeviceAddress", "byUseTransport", "wPort", "sUserName", "sPassword", "cbLoginResult",
                    "pUser", "bUseAsynLogin", "byRes2");
        }
    }
    ...
    public static class NET_DVR_DEVICEINFO_V40 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("struDeviceV30", "bySupportLock", "byRetryLoginTime", "byPasswordLevel", "byRes1",
                    "dwSurplusLockTime", "byRes2");
        }
    }
    ...
    public static class REMOTECONFIGSTATUS_CARD extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("byStatus", "byErrorCode", "byCardNum");
        }
    }
    ...
    public static class NET_DVR_SETUPALARM_PARAM extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byLevel", "byAlarmInfoType", "byRetAlarmTypeV40", "byRetDevInfoVersion",
                    "byRetVQDAlarmType", "byFaceAlarmDetection", "bySupport", "byBrokenNetHttp", "wTaskNo",
                    "byDeployType", "byRes1", "byAlarmTypeURL", "byCustomCtrl");
        }
    }
    ...
    public static class NET_DVR_CARD_CFG_V50 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "dwModifyParamType", "byCardNo", "byCardValid", "byCardType", "byLeaderCard",
                    "byRes1", "byDoorRight", "struValid", "byBelongGroup", "byCardPassword", "wCardRightPlan",
                    "dwMaxSwipeTime", "dwSwipeTime", "wRoomNumber", "wFloorNumber", "dwEmployeeNo", "byName",
                    "wDepartmentNo", "wSchedulePlanNo", "bySchedulePlanType", "byRightType", "byRes2", "dwLockID",
                    "byLockCode", "byRoomCode", "dwCardRight", "dwPlanTemplate", "dwCardUserId", "byCardModelType",
                    "byRes3");
        }
    }
    ...
    public static class NET_DVR_ACS_ALARM_INFO extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "dwMajor", "dwMinor", "struTime", "sNetUser", "struRemoteHostAddr",
                    "struAcsEventInfo", "dwPicDataLen", "pPicData", "wInductiveEventType", "byPicTransType", "byRes1",
                    "dwIOTChannelNo", "pAcsEventInfoExtend", "byAcsEventInfoExtend", "byTimeType", "byRes");
        }
    }
    ...
    public static class NET_DVR_ACS_EVENT_INFO extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byCardNo", "byCardType", "byWhiteListNo", "byReportChannel",
                    "byCardReaderKind", "dwCardReaderNo", "dwDoorNo", "dwVerifyNo", "dwAlarmInNo", "dwAlarmOutNo",
                    "dwCaseSensorNo", "dwRs485No", "dwMultiCardGroupNo", "wAccessChannel", "byDeviceNo",
                    "byDistractControlNo", "dwEmployeeNo", "wLocalControllerID", "byInternetAccess", "byType", "byRes");
        }
    }
    ...
    public static class NET_DVR_FACE_PARAM_CFG extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byCardNo", "dwFaceLen", "pFaceBuffer", "byEnableCardReader", "byFaceID",
    ...
    public static class NET_DVR_FACE_PARAM_STATUS extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byCardNo", "byCardReaderRecvStatus", "byErrorMsg", "dwCardReaderNo",
                    "byTotalStatus", "byTotalStatus", "byFaceID", "byRes");
        }
    }
    ...
    /* V50参数版本 [设备时间主结构体] */
    public class NET_DVR_ACS_EVENT_COND_V50 extends Structure {
        public int dwSize;
        public int dwMajor; // 报警主类型，参考事件上传宏定义，0-全部
        public int dwMinor; // 报警次类型，参考事件上传宏定义，0-全部
        public NET_DVR_TIME struStartTime; // 开始时间
    ...
    /* 设备事件详细信息结构体 */
    public class NET_DVR_ACS_EVENT_DETAIL_V50 extends Structure {
        public int dwSize;
        public byte[] byCardNo = new byte[ACS_CARD_NO_LEN]; // 卡号（mac地址），为0无效
        public byte byCardType; // 卡类型，1-普通卡，2-残疾人卡，3-黑名单卡，4-巡更卡，5-胁迫卡，6-超级卡，7-来宾卡，8-解除卡，为0无效
        public byte byWhiteListNo; // 白名单单号,1-8，为0无效
    ...
    /* 设备事件信息结构体 */
    public class NET_DVR_ACS_EVENT_CFG_V50 extends Structure {
        public int dwSize;
        public int dwMajor; // 报警主类型，参考宏定义
        public int dwMinor; // 报警次类型，参考宏定义
        public NET_DVR_TIME struTime; // 时间
    ...
    public class NET_DVR_IPADDR_V50 extends Structure {
        public byte[] sIpV4 = new byte[16];
    ...
    public static class NET_DVR_INQUEST_CDRW extends Structure {
        ...
        public int dwStatus; /*
                              ...
                              * 当dwType=1或2时，0-刻录正常，1-无光盘或光盘异常，2-光盘已封盘(81不支持)，3-
                              * 光盘空间不足， 4-异常导致审讯终止(81不支持) 当dwType=3时，
                              * 0-刻录正常，1-无光盘或光盘异常，2-光盘已封盘(81不支持)，3-光盘空间不足
                              * 当dwType=4时，0-刻录正常，1-无光盘或光盘异常，2-光盘已封盘(81不支持)，3-
                              * 光盘空间不足 当dwType=5时,0-光盘正常，
                              * 1-无光盘或光盘异常,2-光盘已封盘(81不支持) 当dwType=6或7时, 0-刻录正常,
                              * 1-无光盘或光盘异常, 2-光盘已封盘(81不支持), 3-光盘空间不足
                              */
    ...
    int NET_DVR_Login_V31(String sDVRIP, short wDVRPort, String sUserName, String sPassword,
            FMSGCallBack_V31 lpDeviceInfo);
    ...
    public static class MY_USER_DATA extends Structure {
        public int dwSize;
        public byte[] byteData = new byte[''];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byteData");
        }
    }
    ...
    int NET_DVR_SendWithRecvRemoteConfig(int lHandle, Pointer lpInBuff, int dwInBuffSize, Pointer lpOutBuff,
            int dwOutBuffSize, IntByReference dwOutDataLen);
}
