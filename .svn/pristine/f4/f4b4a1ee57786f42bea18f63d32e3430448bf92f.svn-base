                ...
                if (!token) {
                    ...
                    if (data.meetingInfo == undefined) {
                        ...
                        if (!data.hasJoin) {
                            $txtList = '<dl>' +
                                ...
                                '<dd class="of">' +
                                '<span class="time"><i class="iconfont icon-rili"></i>' + meetingInfo.beginTimeStr + '</span>' +
                                '<a href="javascript:void(0)" class="fr signApBtn" onclick="checkHasGz(this)">点击报名</a>' +
                                '</dd>' +
                                '</dl>'
                        } else {
                            ...
                            $txtList = '<dl>' +
                                ...
                                '<dd class="of">' +
                                '<span class="time"><i class="iconfont icon-rili"></i>' + meetingInfo.beginTimeStr + '</span>' +
                                '<a href="success.html" class="fr signApBtn btngreen1">查看会议</a>' +
                                '</dd>' +
                                '</dl>'
                        }
                    }
                    ...
                    if (data.meetingInfo == undefined) {
                        $txtList = '<dl>' +
                            '<dt>暂无会议</dt>' +
                            '<dd class="of">' +
                            '<span class="time"><i class="iconfont icon-rili"></i></span>' +
                            '<a href="hygl.html?add" class="fr signApBtn">添加会议</a>' +
                            '</dd>' +
                            '</dl>'
                    } else {
                        var meetingInfo = data.meetingInfo;
                        ...
                        $txtList = '<dl>' +
                            '<dt>' + meetingInfo.title + '</dt>' +
                            '<dd class="of">' +
                            '<span class="time"><i class="iconfont icon-rili">' + meetingInfo.beginTimeStr + '</i></span>' +
                            '</dd>' +
                            '<dd class="txtR">' +
                            '<a href="hygl.html?edit" class="signApBtn mr5">编辑</a>' +
                            '<a href="hygl.html?add" class="signApBtn btngreen1">新增</a>' +
                            '</dd>' +
                            '</dl>'
                    }
                }
