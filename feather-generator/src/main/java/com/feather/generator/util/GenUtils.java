...
import com.feather.generator.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable, String operName) {
        ...
        if (StringUtils.isBlank(genTable.getTplCategory())) {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        if (arraysContains(GenConstants.COLUMNTYPE_STR, dataType)) {
            ...
            column.setJavaType(GenConstants.TYPE_BLOB);
            column.setHtmlType(GenConstants.HTML_INPUT);
        } else if (arraysContains(GenConstants.COLUMNTYPE_CLOB, dataType)) {
            column.setJavaType(GenConstants.TYPE_STRING);
            column.setHtmlType(GenConstants.HTML_INPUT);
        }
    ...
    public static String replaceText(String text) {
        return text != null ? text.replaceAll("(?:表|羽毛)", "") : "";
    }
