package com.feather.generator.controller;
...
import com.feather.common.utils.security.PermissionUtils;
...
public class GenController extends BaseController {
    private String prefix = "system/tool/gen";
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"feather.zip\"");
