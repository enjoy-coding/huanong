...
import com.feather.common.exception.user.CaptchaException;
import com.feather.common.exception.user.RoleBlockedException;
...
import com.feather.framework.shiro.service.SysLoginService;
...
public class FreeRealm extends AuthorizingRealm {
    private static final Logger log = LoggerFactory.getLogger(FreeRealm.class);
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0) {
        ...
        if (user.isAdmin()) {
            // info.addRole("admin");
            List<SysRole> allRole = roleService.selectRoleAll();
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        CustomeToken upToken = (CustomeToken) token;
        ...
        SysUser user = null;
        try {
            user = loginService.login(username, password, matchPassword);
