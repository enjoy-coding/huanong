package com.feather.framework.shiro.web.filter.online;
...
import com.feather.common.enums.OnlineStatus;
        ...
        if (session != null && session instanceof OnlineSession) {
            ...
            if (isGuest == true) {
                ...
                if (user != null) {
                    ...
                    onlineSession.setDeptName(user.getDept() != null ? user.getDept().getDeptName() : "");
